    ...
    <section className="flex flex-col gap-4 w-full md:w-[80%] lg:w-[500px] mb-5 m-auto">
      ...
      <div className="flex flex-col gap-5 text-sm">
        <p className="text-[#ff0000] ">
          ...
          <span className="hover:text-[#ae4ad9] px-1 text-[#288ad6] dark:text-[#ff9601] dark:hover:text-[#ff0000] cursor-pointer hover:underline">
            liên hệ
          </span>
          với chúng tôi
        </p>
      ...
      <div className="flex items-center w-full gap-2">
        <span className="border rounded select-none border-gray-300 w-1/2 h-[35px] text-xl text-[#288ad6] flex items-center justify-center ">
          {randomString}
        </span>
        <button
          onClick={() => (handleRandomString(), setCheckString(""))}
