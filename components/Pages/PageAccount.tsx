...
import { FaComment, FaComments, FaInfo, FaLock, FaSignOutAlt } from "react-icons/fa";
...
export default function PageAccount({ dashboard }: IAppProps) {
    ...
    return (
        <section className="grid lg:gap-6 lg:grid-cols-4">
            <div className="col-span-1 w-full">
                <div className="bg-[#222222] flex items-center justify-between gap-2 text-white px-2 pt-2">
                    <Image src={avt_default} className="w-[80px] h-[80px] object-cover" alt="avatar" width={100} height={100} />
                    ...
                    <button
                        ...
                        className={`${!isOpenDashboard ? "rotate-180" : ""} duration-300 transition-all`}>
                        <IoIosArrowDown size={25} />
                    </button>
                </div>
                <ul className={`text-sm mt-6 text-[#333333] dark:text-[#f2f2f2] dark:bg-[#222222] bg-[#f2f2f2] font-light ${isOpenDashboard ? "" : "hidden"}`}>
                    <Link href="/account/dashboard">
                        <li
                            className={`flex items-center gap-1 px-5  py-2  
                     ${dashboard == "dashboard" ? "bg-[#eaeaea] dark:bg-[#333] border-l-[3px] border-[#ee2c74] font-bold" : ""}`}>
                    ...
                    <Link href="/account/follow">
                        <li
                            className={`flex items-center gap-1 px-5  py-2  
                     ${dashboard == "follow" ? "bg-[#eaeaea] dark:bg-[#333] border-l-[3px] border-[#ee2c74] font-bold" : ""}`}>
                    ...
                    <Link href="/account/linhthach">
                        <li
                            className={`flex items-center gap-1 px-5  py-2  
                     ${dashboard == "linhthach" ? "bg-[#eaeaea] dark:bg-[#333] border-l-[3px] border-[#ee2c74] font-bold" : ""}`}>
                    ...
                    <Link href="/account/comment">
                        <li
                            className={`flex items-center gap-1 px-5  py-2  
                     ${dashboard == "comment" ? "bg-[#eaeaea] dark:bg-[#333] border-l-[3px] border-[#ee2c74] font-bold" : ""}`}>
                    ...
                    <Link href="/account/notification">
                        <li
                            className={`flex items-center gap-1 px-5  py-2  
                     ${dashboard == "notification" ? "bg-[#eaeaea] dark:bg-[#333] border-l-[3px] border-[#ee2c74] font-bold" : ""}`}>
