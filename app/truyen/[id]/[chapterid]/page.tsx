            ...
            <main className="w-screen  lg:w-[1200px] bg-white flex flex-col gap-2 p-2  m-auto">
                ...
                <nav className=' text-xl flex gap-1 flex-col'>
                    <span className='flex flex-wrap gap-1 '>
                        <h1 className='hover:text-[#ae4ad9] cursor-pointer hover:underline font-medium text-[#288ad6]'>Kiếm Nghịch Thương Khung </h1>
                        <p >- Chapter 1</p></span>
                    <p className='text-base italic '>[Cập nhật lúc: 2024-03-15 06:50:13]</p>
                </nav>
                <section className='text-center flex flex-col gap-2 justify-center'>
                    <nav className='flex text-sm justify-center'>
                        <div className='w-2 md:w-6  relative'>
                            ...
                            <span className="absolute w-3 h-3 top-1 left-1 inline-flex rounded-full bg-red-500"></span></div>
                        <h3 className=''>Nếu không xem được truyện vui lòng đổi <span className='hover:text-[#ae4ad9] cursor-pointer hover:underline font-medium text-[#288ad6]'>"SERVER ẢNH"</span> bên dưới</h3>
                    </nav>
                    <p className='text-[#ff0000] font-bold text-sm px-3'>Vui lòng bấm "BÁO LỖI" nếu không xem được truyện</p>
                    <div className='flex gap-1 justify-center text-white font-medium'>
                        <button className='hover:bg-[#449b44] bg-[#5cb85c] p-1 px-2  rounded-md border border-[#4cae4c]'>Server 1</button>
                        <button className='hover:bg-[#286090] bg-[#337ab7] p-1 px-2  rounded-md border border-[#204d74]'>Server 2</button>
                    </div>
                    <button className="bg-[#f0ad4e] p-1 px-2 w-max m-auto rounded-md flex items-center text-white gap-1 font-medium border hover:bg-[#ec971f] border-[#eea236]"><IoIosWarning /> Báo lỗi</button>
                ...
                <tr className='w-full py-4 flex justify-center items-center flex-col bg-black gap-1'>
                    <td><img className='w-full h-[700px] lg:w-[700px] lg:h-[1200px] object-cover' src="https://naetmcxt.xyz/nettruyen/blue-archive-global/2/0.jpg" alt="" /></td>
                    <td><img  className='w-full h-[700px] lg:w-[700px] lg:h-[1200px] object-cover'src="https://naetmcxt.xyz/nettruyen/blue-archive-global/2/0.jpg" alt="" /></td>
                </tr>
