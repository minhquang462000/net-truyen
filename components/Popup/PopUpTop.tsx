...
export default function PopUpTop(props: IAppProps) {
  return (
    <li className=" group/rank   cursor-pointer relative   md:border-r-[1px] border-gray-300  ">
      ...
      <div className="max-h-0 md:absolute dark:text-black md:bg-white z-50 overflow-hidden md:shadow-md shadow-black md:w-[500px] top-[100%] group-hover/rank:max-h-[400px] transitionProperty-[max-height] duration-300">
        <ul className="w-full md:p-0 md:mt-0  p-3 text-sm grid  grid-cols-2  mt-2 border-white">
          ...
          <Link href={"/tim-truyen?sortKey=monthly"}>
            <li className=" hover:text-[#ff9601]  md:hover:text-[#ae4ad9] gap-2 dark:hover:bg-transparent dark: dark:hover:text-[#ff9601]  md:hover:bg-gray-100 flex items-center hover:bg-white pl-3 md:p-2       border-t border-l  ">
              <FaRegEye size={18} />
              Top tháng
            </li></Link>
          <Link href={"/tim-truyen?sortKey=views"}>
